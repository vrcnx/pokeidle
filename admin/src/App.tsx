...
export type Page = "analytics" | "liveops" | "users" | "map" | "chat" | "bugs" | "errors" | "tournaments" | "giveaways" | "massgift" | "referrals" | "reddit" | "polls" | "audit" | "announcements" | "broadcast" | "discord";
...
const PAGES: Page[] = [
  ...
  "bugs", "errors", "tournaments", "giveaways", "massgift", "referrals", "reddit", "polls", "audit", "announcements", "broadcast", "discord",
];
...
const NAV_GROUPS: NavGroupDef[] = [
  ...
  { label: "Events", items: [
    ...
    { page: "giveaways", label: "Rewards", icon: <IconGift />, covers: ["massgift", "referrals", "reddit"] },
  ] },
  { label: "Tools", items: [
...
const PALETTE_TARGETS: PaletteTarget[] = [
  ...
  { page: "reddit",        label: "Reddit reward", group: "Events" },
...
export function App() {
  ...
  const PAGE_TITLES: Record<Page, string> = {
    ...
    giveaways: "Giveaways", massgift: "Mass gift", referrals: "Referrals", reddit: "Reddit reward",
    polls: "Polls", audit: "Audit log",
  ...
  return (
    <div className="admin-shell">
      ...
      <div className="admin-body">
        ...
        {(page === "giveaways" || page === "massgift" || page === "referrals" || page === "reddit") && (
